# Open Platform Formation

Open Platform Formation is a simple application to use as a basis for formations on [Axelor Open Platform](https://github.com/axelor/axelor-open-platform) framework.
...
```bash
$ git clone git@github.com:mga-axelor/open-platform-formation.git
```

and build the project:

```bash
$ cd /path/to/open-platform-formation
...
Running at http://localhost:8080/open-platform-formation
```
...
You can also run the application inside eclipse using eclipse WTP tools. Create a tomcat8.5 server add the open-platform-formation module and run the server.
